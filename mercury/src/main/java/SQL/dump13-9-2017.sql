...
SELECT pg_catalog.setval('invoices_invoice_id_seq', 21, true);
...
COPY office_orders (office_order_id, office_order_date, office_order_info, device_id, customer_id, employee_id, office_order_sum, invoice_id) FROM stdin;
1	2017-08-04	ne pali	2	2	1	\N	\N
2	2017-08-04	schupen display	3	\N	1	\N	\N
4	2017-08-08	zxvczvcv	2	1	1	\N	\N
5	\N		3	1	3	\N	6
3	2017-08-08	sadsadsad	2	1	3	278.56	24
\.
...
SELECT pg_catalog.setval('service_parts_service_part_id_seq', 5, true);
...
SELECT pg_catalog.setval('services_list_service_list_id_seq', 9, true);
