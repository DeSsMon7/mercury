package com.ash.mercury.service.pres;
...
public class ServiceController implements Serializable {
    ...
    @EJB
    private com.ash.mercury.service.control.ServiceFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/msgs_EN").getString("ServiceCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/msgs_EN").getString("ServiceUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/msgs_EN").getString("ServiceDeleted"));
        if (!JsfUtil.isValidationFailed()) {
