...
public class InvoiceController implements Serializable {
    ...
    public Invoice getSelected() {
        if (selected == null) {
            ...
            System.out.println("Минаваш ли през мен?");
        }
        return selected;
    }
    ...
    public Invoice prepareCreate() {
        System.out.println("Минавам ли от тук?");
        selected = new Invoice();
    ...
    public Integer findNextSequence() {
        ...
        System.out.println("findNextSequence" + ejbFacade.findNextSequence());
        System.out.println("findNextSequence + 1: " + ejbFacade.findNextSequence() + 1);
        return result;
    }
