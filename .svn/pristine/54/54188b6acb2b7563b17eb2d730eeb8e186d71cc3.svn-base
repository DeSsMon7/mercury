...
public class OfficeOrderController implements Serializable {
    ...
    public void onRowEdit(RowEditEvent event) {
        ...
        for(int i = 0; i < customerList.size() ; i++) {
         customer0.setCustomerId(customerList.get(i).getCustomerId());
         customer0.setCustomerFirstname(customerList.get(i).getCustomerFirstname());
         customer0.setCustomerSurname(customerList.get(i).getCustomerSurname());
         customer0.setCustomerEmail(customerList.get(i).getCustomerEmail());
        
        }
        
        selected.setCustomerId(customer0);
