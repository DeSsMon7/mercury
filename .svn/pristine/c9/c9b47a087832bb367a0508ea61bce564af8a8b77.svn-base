package com.ash.mercury.customer.pres;
...
public class CustomerController implements Serializable {
    ...
    @EJB
    private com.ash.mercury.customer.control.CustomerFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/msgs_EN").getString("CustomerCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/msgs_EN").getString("CustomerUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/msgs_EN").getString("CustomerDeleted"));
        if (!JsfUtil.isValidationFailed()) {
            selected = null; // Remove selection
            items = null;    // Invalidate list of items to trigger re-query.
        }
    ...
    public List<Customer> getItemsAvailableSelectOne() {
        System.out.println("List Customers: za INVOICES ") ;
        return getFacade().findAll();
    }

    public List<Customer> getCustomerId() {
        return getFacade().findCustomerId();
    }
